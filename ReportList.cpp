 ...
 ******************************************************************************
 *
 *	COPYRIGHT (C) 1999-2008 LOGICA NEDERLAND B.V. - ALL RIGHTS RESERVED
 *
 ******************************************************************************/
...
const char* ReportList::m_pszTexts[] = 
	{	
		// BRANDING_ID
		"Knfhb` SdrsEq`ld,Sdrs Dwdbtshnm Qdonqs",			// GB
		"Knfhb` SdrsEq`ld,Sdrsdqfdamhroqnsnjnkk",			// DE
		"Knfhb` SdrsEq`ld,Q`oonqs c&Dwèbtshnm ct Sdrs",		// FR
		"Knfhb` SdrsEq`ld,Sdrs Dwdbtshd Q`oonqs",			// NL
		"Knfhb` SdrsEq`ld,Qdk`str Dwdbtshnmhr Sdms`shnmhr",	// LT
