...
#define REPORT_FOOTER		"TestFrame Engine v2008.06. Copyright (C) 1999-2008 Logica Nederland B.V. All rights reserved."
...
)
{
	...
	if ( m_pStartStruct != 0 && pSetting != 0 )
	{
		...
		if ( m_pLogParser->Good() )
		{
			...
			m_strLicenseName = pSetting->Get( "LICENSE", "Name" );
...
//						===================
{
	...
	Write( Ungarble( m_pReportList->GetText( ReportList::BRANDING_ID ) ) );
...
//						=======================
{
	...
	strTag = m_pReportList->GetText( ReportList::ENGINEVERSION_ID );
	...
	// Write the license information; the first three header tags.
	...
	// Write the engine version and build; tags four and five.
